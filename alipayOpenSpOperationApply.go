...
func (a AlipayOpenSpOperationApply) getMethod() string {
	return "alipay.open.sp.operation.apply"
}

func (a AlipayOpenSpOperationApply) getAppAuthToken() string {
	return a.appAuthToken
}

func (a AlipayOpenSpOperationApply) getReq() interface{} {
	return a.input
}
